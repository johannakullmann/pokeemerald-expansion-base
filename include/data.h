...
extern const struct SpriteFrameImage gTrainerBackPicTable_June[];
extern const struct SpriteFrameImage gTrainerBackPicTable_August[];
extern const struct SpriteFrameImage gTrainerBackPicTable_Ruth[];
