...
enum {
    ...
    NATIONAL_DEX_TOXATIEL,
    NATIONAL_DEX_TOXATOO,
    NATIONAL_DEX_TOXATRICE,
    NATIONAL_DEX_GROCKO,
    NATIONAL_DEX_RUBECKO,
    NATIONAL_DEX_DRABUNCLE,
    NATIONAL_DEX_CHIMERA1,
    NATIONAL_DEX_CHIMERA2,
    NATIONAL_DEX_CHIMERA3,
    NATIONAL_DEX_HATCHIK,
    NATIONAL_DEX_DODO2,
    NATIONAL_DEX_MBIELU,
    NATIONAL_DEX_MBIELAVA,
    NATIONAL_DEX_CHUBGRUB,
};

#define KANTO_DEX_COUNT     NATIONAL_DEX_MEW
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI

#if P_CUSTOM_POKEMON == TRUE 
    #define NATIONAL_DEX_COUNT NATIONAL_DEX_CHUBGRUB
