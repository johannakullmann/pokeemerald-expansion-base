...
enum {
    ...
    MB_UNUSED_56,
    MB_UNUSED_57,
    MB_IMPASSABLE_STRENGTH_EAST,
    MB_IMPASSABLE_STRENGTH_WEST,
    MB_IMPASSABLE_STRENGTH_NORTH,
    MB_IMPASSABLE_STRENGTH_SOUTH,
    MB_IMPASSABLE_STRENGTH_NORTHEAST,
    MB_IMPASSABLE_STRENGTH_NORTHWEST,
    MB_IMPASSABLE_STRENGTH_SOUTHEAST,
    MB_IMPASSABLE_STRENGTH_SOUTHWEST,
