...
#define OW_FLAG_NO_ENCOUNTER        FLAG_DEBUG_DISABLE_WILD_ENCOUNTERS  // If this flag is set, wild encounters will be disabled.
#define OW_FLAG_NO_TRAINER_SEE      FLAG_DEBUG_DISABLE_TRAINER_VISION  // If this flag is set, trainers will not battle the player unless they're talked to.
#define OW_FLAG_NO_COLLISION        FLAG_DEBUG_DISABLE_TERRAIN_COLLISION  // If this flag is set, the player will be able to walk over tiles with collision. Mainly intended for debugging purposes.
