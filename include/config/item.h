...
#define I_SHINY_LURE_ADDITIONAL_ROLLS   10          // Amount of additional shiny rolls if the player has the Shiny Lure active.
...
#define VAR_LAST_REPEL_LURE_USED    VAR_LAST_REPEL_LURE_ITEM       // If this var has been assigned, last Repel/Lure used will be saved and the player will get prompted with the vanilla repel YES/NO option, unless I_REPEL_LURE_MENU is set to TRUE.
