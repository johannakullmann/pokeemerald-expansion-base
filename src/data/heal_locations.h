static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PACIFIDLOG_TOWN - 1] = {MAP_GROUP(PACIFIDLOG_TOWN), MAP_NUM(PACIFIDLOG_TOWN), 48, 20},
    ...
    [HEAL_LOCATION_SANDYSHORE_TOWN - 1] = {MAP_GROUP(SANDYSHORE_TOWN), MAP_NUM(SANDYSHORE_TOWN), 25, 17},
};
