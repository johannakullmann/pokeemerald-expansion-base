...
static const union AnimCmd *const sAnims_June[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_August[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Ruth[] ={
    sAnim_GeneralFrame0,
};
...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_JUNE] = sAnims_June,
    [TRAINER_PIC_AUGUST] = sAnims_August,
    [TRAINER_PIC_RUTH] = sAnims_Ruth,
};
