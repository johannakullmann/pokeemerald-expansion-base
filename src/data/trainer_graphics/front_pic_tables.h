const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_LEADER_MAY] = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_JUNE] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_AUGUST] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_RUTH] = {.size = 8, .y_offset = 1},
};
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(LEADER_MAY, gTrainerFrontPic_LeaderMay, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(JUNE, gTrainerFrontPic_June, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(AUGUST, gTrainerFrontPic_August, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(RUTH, gTrainerFrontPic_Ruth, TRAINER_PIC_SIZE),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(LEADER_MAY, gTrainerPalette_RubySapphireMay),
    ...
    TRAINER_PAL(JUNE, gTrainerPalette_June),
    TRAINER_PAL(AUGUST, gTrainerPalette_August),
    TRAINER_PAL(RUTH, gTrainerPalette_Ruth),
};
