...
static const u16 sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_SKY_PILLAR,                 MAPSEC_PACIFIDLOG_TOWN},
...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_SANDYSHORE_TOWN] = {MAP_GROUP(MAP_SANDYSHORE_TOWN), MAP_NUM(MAP_SANDYSHORE_TOWN), HEAL_LOCATION_SANDYSHORE_TOWN},
...
static void RegionMap_InitializeStateBasedOnSSTidalLocation(void)
{
    ...
    case SS_TIDAL_LOCATION_ROUTE131:
        sRegionMap->mapSecId = MAPSEC_PACIFIDLOG_TOWN;
        break;
    default:
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_SANDYSHORE_TOWN:
        return FlagGet(FLAG_VISITED_SANDYSHORE_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
{
    u8 spriteId;
    struct SpriteSheet sheet = {sRegionMapPlayerIcon_AugustGfx, 0x80, tileTag};
    struct SpritePalette palette = {sRegionMapPlayerIcon_AugustPal, paletteTag};
    ...
    {
        sheet.data = sRegionMapPlayerIcon_JuneGfx;
        palette.data = sRegionMapPlayerIcon_JunePal;
    }
    LoadSpriteSheet(&sheet);
    LoadSpritePalette(&palette);
...
//Fly destinations
static const u16 sFlyDestinations[] =
{
    ...
    MAPSEC_SANDYSHORE_TOWN,
};

static const u16 sFlyDestinationToCanFlyFlag[] =
{
    ...
    [MAPSEC_SANDYSHORE_TOWN] = FLAG_VISITED_SANDYSHORE_TOWN,
};
...
static void CreateFlyDestIcons(void)
{
    ...
    for (i = 0; i < (sizeof(sFlyDestinations) / sizeof(u16)); i++)
    {
        mapSecId = sFlyDestinations[i];
        canFlyFlag = sFlyDestinationToCanFlyFlag[mapSecId];
