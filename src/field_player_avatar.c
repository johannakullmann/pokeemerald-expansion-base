...
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_AUGUST_NORMAL,     OBJ_EVENT_GFX_JUNE_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_AUGUST_MACH_BIKE,  OBJ_EVENT_GFX_JUNE_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_AUGUST_ACRO_BIKE,  OBJ_EVENT_GFX_JUNE_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_AUGUST_SURFING,    OBJ_EVENT_GFX_JUNE_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_AUGUST_UNDERWATER, OBJ_EVENT_GFX_JUNE_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_AUGUST_FIELD_MOVE, OBJ_EVENT_GFX_JUNE_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_AUGUST_FISHING,    OBJ_EVENT_GFX_JUNE_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_AUGUST_WATERING,   OBJ_EVENT_GFX_JUNE_WATERING},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_AUGUST_FIELD_MOVE, OBJ_EVENT_GFX_JUNE_FIELD_MOVE},
};
...
static const u16 sPlayerAvatarGfxToStateFlag[GENDER_COUNT][5][2] =
{
    [MALE] =
    {
        {OBJ_EVENT_GFX_AUGUST_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_AUGUST_MACH_BIKE,  PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_AUGUST_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_AUGUST_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_AUGUST_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [FEMALE] =
    {
        {OBJ_EVENT_GFX_JUNE_NORMAL,         PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_JUNE_MACH_BIKE,      PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_JUNE_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_JUNE_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_JUNE_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
    }
};
...
u8 GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    switch (gfxId)
    {
    case OBJ_EVENT_GFX_JUNE_NORMAL:
    case OBJ_EVENT_GFX_JUNE_MACH_BIKE:
    case OBJ_EVENT_GFX_JUNE_ACRO_BIKE:
    case OBJ_EVENT_GFX_JUNE_SURFING:
    case OBJ_EVENT_GFX_JUNE_FIELD_MOVE:
    case OBJ_EVENT_GFX_JUNE_UNDERWATER:
    case OBJ_EVENT_GFX_JUNE_FISHING:
    case OBJ_EVENT_GFX_JUNE_WATERING:
        return FEMALE;
    default:
        return MALE;
    }
    ...
    if (!TestPlayerAvatarFlags(PLAYER_AVATAR_FLAG_SURFING))
    {
        for (i = 0; i < PARTY_SIZE; i++)
        {
            if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES) == SPECIES_NONE)
                break;
            if (MonKnowsMove(&gPlayerParty[i], MOVE_SURF) || MonKnowsInnateFieldMove(&gPlayerParty[i], MOVE_SURF))
                return TRUE;
        }
    }
    return FALSE;
