...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(TOXATIEL),
    HOENN_TO_NATIONAL(TOXATOO),
    HOENN_TO_NATIONAL(TOXATRICE),
    HOENN_TO_NATIONAL(GROCKO),
    HOENN_TO_NATIONAL(RUBECKO),
    HOENN_TO_NATIONAL(DRABUNCLE),
    HOENN_TO_NATIONAL(CHIMERA1),
    HOENN_TO_NATIONAL(CHIMERA2),
    HOENN_TO_NATIONAL(CHIMERA3),
    HOENN_TO_NATIONAL(HATCHIK),
    HOENN_TO_NATIONAL(DODO2),
    HOENN_TO_NATIONAL(MBIELU),
    HOENN_TO_NATIONAL(MBIELAVA),
};
...
#if P_LVL_UP_LEARNSETS >= CUSTOM_LEARNSETS
...
static const struct SpriteTemplate sTrainerBackSpriteTemplates[] =
{
    ...
    [TRAINER_BACK_PIC_JUNE] = {
        ...
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_June,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
    [TRAINER_BACK_PIC_AUGUST] = {
        ...
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_August,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
    [TRAINER_BACK_PIC_RUTH] = {
        ...
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_Ruth,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
};
...
const u8 *GetTrainerPartnerName(void)
{
    if (gBattleTypeFlags & BATTLE_TYPE_INGAME_PARTNER)
    {
        ...
        if (gPartnerTrainerId == TRAINER_PARTNER(PARTNER_RUTH_TOXATIEL) 
                    || gPartnerTrainerId == TRAINER_PARTNER(PARTNER_RUTH_GROCKO) 
                    || gPartnerTrainerId == TRAINER_PARTNER(PARTNER_RUTH_MERAKID))
        {
            return GetTrainerNameFromId(TRAINER_RUTH_PACIFIDLOG_TOXATIEL);
        }
        else
        {
...
u16 PlayerGenderToFrontTrainerPicId(u8 playerGender)
{
    if (playerGender != MALE)
        return FacilityClassToPicIndex(FACILITY_CLASS_JUNE);
    else
        return FacilityClassToPicIndex(FACILITY_CLASS_AUGUST);
}
