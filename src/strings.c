...
const u8 gText_DefaultNameStu[] = _("August");
...
const u8 gText_DefaultNameJude[] = _("Gino");
...
const u8 gText_DefaultNameRuthie[] = _("Lauren");
...
const u8 gText_ChooseStarter[] = _("Select a Poké Ball to see\nwhat Pokémon is inside!");
const u8 gText_StarterMonDescription[] = _("{STR_VAR_1}, the {STR_VAR_2}-type Pokémon.\nDo you choose this Pokémon?");
...
const u8 gText_RoarEffectsLingered[] = _("But the effects of Roar\nlingered from earlier.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_RuthMatchCallDesc[] = _("Best Friend");
const u8 gText_RuthMatchCallName[] = _("Ruth");
const u8 gText_BikeShopMatchCallDesc[] = _("Bike Shop");
const u8 gText_BikeShopMatchCallName[] = _("Rydel's");
