...
const u8 gPCText_Savanna[] = _("Savannah");
...
const u8 gText_PokenavRibbons_MonListButtons[] = _("{A_BUTTON}Ribbon {B_BUTTON}Cancel");
...
const u8 gEasyChatGroupName_Lifestyle[] = _("Lifestlye");
